...
public class ConnectToSqlDB {
    ...
    public static void insertProfileToSqlTable(User user,String tableName, String columnName1, String columnName2, String columnName3)
    {
        try {
            connectToSqlDatabase();
                ps = connect.prepareStatement("INSERT INTO "+tableName+" ( " + columnName1 + "," + columnName2 + ","
                        + columnName3+")" + "VALUES(?,?,?)");
                ps.setString(1,user.getStName());
                ps.setInt(2,Integer.parseInt(user.getStID()));
    ...
    public static void main(String[] args)throws IOException, SQLException, ClassNotFoundException {
        ...
        //insertProfileToSqlTable(new User("Arif","450","03-11-1999"),"Students",
        //        "stName","stID","stDOB");
